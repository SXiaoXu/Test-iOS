...
-(void)setupChildViewControllers{
   ...
   [self setupOneChildController:[[VVNavigationController alloc]initWithRootViewController:[[HomeViewController alloc] init]]title:@"示例" image:nil
                  selectedImage:nil];
//    [self setupOneChildController:[[VVNavigationController alloc]initWithRootViewController:[[GroupMessageViewController alloc] init] ]title:@"群聊" image:nil
//                    selectedImage:nil];
//   
    [self setupOneChildController:[[VVNavigationController alloc]initWithRootViewController:[[LoginViewController alloc] init]]title:@"登录" image:nil
                        selectedImage:nil];
    [self setupOneChildController:[[VVNavigationController alloc]initWithRootViewController:[[RestaurantController alloc] init]]title:@"餐厅测试" image:nil
                    selectedImage:nil];
}
